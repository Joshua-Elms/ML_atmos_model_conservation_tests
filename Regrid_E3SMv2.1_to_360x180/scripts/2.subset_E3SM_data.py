...
output_path = Path(
    "/N/scratch/jmelms/ML_atmos_model_conservation_tests_scratch_data/B.energy_balance/data/original_native_grid/E3SM_IC_native_grid.nc"
)
...
# perturbed
input_path = Path(
    "/N/slate/jmelms/projects/ML_atmos_model_conservation_tests/B.energy_balance/data/E3SM_runs/v2.1.WCYCLSSP370_20180201-20180401_12n32p_trial_05/run/v2.1.WCYCLSSP370_20180201-20180401_12n32p_trial_05.eam.h1.2018-02-01-00000.nc"
)
output_path = Path(
    "/N/scratch/jmelms/ML_atmos_model_conservation_tests_scratch_data/B.energy_balance/data/p5k_native_grid/E3SM_IC_native_grid.nc"
)
